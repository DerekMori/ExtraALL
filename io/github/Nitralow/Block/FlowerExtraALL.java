...
public class FlowerExtraALL extends Block implements IPlantable
{
    protected FlowerExtraALL(int par1, Material par2Material)
    {
    ...
    protected FlowerExtraALL(int par1)
    {
    ...
    {
        return par1 == Block.grass.blockID || par1 == Block.dirt.blockID || par1 == Block.tilledField.blockID || par1 == Interesting.Iceground.blockID || par1 == Interesting.IcegroundOre.blockID;
    }
